...
void soft_max(TYPE net_outputs[possible_outputs], TYPE activations[possible_outputs]) {
    ...
    loop1: for(i=0; i < possible_outputs; i++) {
        sum += exp(-activations[i]);
    }
    loop2: for(i=0; i < possible_outputs; i++) {
...
void matrix_vector_product_with_bias_input_layer(TYPE biases[nodes_per_layer],
    ...
    int i,j;
    loop1: for(j = 0; j < nodes_per_layer; j++) {
        activations[j] = (TYPE)0.0;
        loop2: for (i = 0; i < input_dimension; i++) {
...
void matrix_vector_product_with_bias_second_layer(TYPE biases[nodes_per_layer],
    ...
    int i,j;
    loop1: for (i = 0; i < nodes_per_layer; i++) {
        activations[i] = (TYPE)0.0;
        loop2: for(j = 0; j < nodes_per_layer; j++) {
...
void matrix_vector_product_with_bias_output_layer(TYPE biases[possible_outputs],
                                                 ...
                                                 TYPE input_activations[nodes_per_layer]){
    int i, j;
    loop1: for(j = 0; j < possible_outputs; j++) {
        activations[j] = (TYPE)0.0;
        loop2: for (i = 0; i < nodes_per_layer; i++) {
...
void get_delta_matrix_weights3(TYPE delta_weights3[nodes_per_layer*possible_outputs],
    ...
    int i, j;
    loop1: for( i = 0; i < nodes_per_layer; i++) {
        loop2: for( j = 0; j < possible_outputs; j++) {
...
void get_delta_matrix_weights1(TYPE delta_weights1[input_dimension*nodes_per_layer],
    ...
    int i, j;
    loop1: for( i = 0; i < input_dimension; i++) {
        loop2: for( j = 0; j < nodes_per_layer; j++) {
...
void update_weights(TYPE weights1[input_dimension*nodes_per_layer],
    ...
    loop3: for(i=0; i < nodes_per_layer; i++) {
    ...
    loop4: for(i=0; i < input_dimension; i++) {
        loop5: for(j = 0; j < nodes_per_layer; j++) {
            weights1[i*nodes_per_layer + j] = (weights1[i*nodes_per_layer + j]/norm);
        }
    }
    loop6: for(i=0; i < nodes_per_layer; i++) {
    ...
    loop7: for(i=0; i < nodes_per_layer; i++) {
        loop8: for(j = 0; j < nodes_per_layer; j++) {
    ...
    loop9: for(i=0; i < nodes_per_layer; i++) {
    ...
    loop10: for(i=0; i < nodes_per_layer; i++) {
        loop11: for(j = 0; j < nodes_per_layer; j++) {
            weights2[i*nodes_per_layer + j] = (weights2[i*nodes_per_layer + j]/norm);
        }
    }
    loop12: for(i=0; i < nodes_per_layer; i++) {
    ...
    loop13: for(i=0; i < nodes_per_layer; i++) {
        loop14: for(j = 0; j < possible_outputs; j++) {
    ...
    loop15: for(i=0; i<possible_outputs;i++) {
    ...
    loop16: for(i=0; i < nodes_per_layer; i++) {
        loop17: for(j = 0; j < possible_outputs; j++) {
            weights3[i*possible_outputs + j] = (weights3[i*possible_outputs + j]/norm);
        }
    }
    loop18: for(i=0; i < possible_outputs; i++) {
...
void backprop(TYPE weights1[input_dimension*nodes_per_layer], 
    ...
    loop1: for(i=0; i<training_sets; i++) {
        loop2: for(j=0;j<nodes_per_layer;j++) {
